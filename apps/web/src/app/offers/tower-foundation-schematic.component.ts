    ...
    <div class="schematics-grid">
      ...
      <div class="schematic-card technical-border">
        <div class="schematic-header">
          <span class="font-label-caps"
            >Planta de Locação Centro das Cavas</span
          >
        ...
        <div class="svg-canvas-wrapper technical-grid">
          <svg
            class="schematic-svg"
            viewBox="0 0 400 400"
            aria-label="Planta de locação das pernas da torre"
          >
            <!-- Grid crosshairs -->
            <line
              x1="200"
      ...
      <div class="schematic-card technical-border">
        ...
        <div class="svg-canvas-wrapper technical-grid">
          <svg
            class="schematic-svg"
            viewBox="0 0 400 320"
            aria-label="Corte transversal de fundação"
          >
            <!-- Ground Line -->
            <line
              x1="30"
            ...
            <polygon
              points="140,210 260,210 280,260 120,260"
              fill="#cbd5e1"
              stroke="#434653"
              stroke-width="1.5"
            ></polygon>
      ...
      <div class="schematic-card technical-border">
        ...
        <div class="svg-canvas-wrapper technical-grid">
          <svg
            class="schematic-svg"
            viewBox="0 0 400 240"
            aria-label="Diagrama do gabarito inclinado"
          >
            <!-- Triangle -->
            <path
              d="M 80 190 L 320 190 L 320 40 Z"
              fill="#edf0ff"
              stroke="#094cb2"
              stroke-width="2"
            ></path>

...
import { GuyWireHistory } from '@lt-offers/domain';
import { GuyWiresApi } from './guy-wires-api.service';

@Component({
  selector: 'app-guy-wire-history',
  imports: [
    RouterLink,
    DatePipe,
  ...
  template: `
    <section>
      ...
      <a matButton routerLink="/catalogs/guy-wires">Voltar à listagem</a>
...
export class GuyWireHistoryComponent {
  ...
  readonly history = signal<GuyWireHistory | null>(null);

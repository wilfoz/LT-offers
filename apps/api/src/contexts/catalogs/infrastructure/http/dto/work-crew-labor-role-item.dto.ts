...
export class WorkCrewLaborRoleItemDto {
  @IsInt({
    message:
      'O identificador do cargo de mão de obra deve ser um número inteiro',
  })
  ...
  @Validate(PositiveNonZeroDecimal, [2], {
    message:
      'A quantidade de mão de obra deve ser um número decimal maior que zero com no máximo 2 casas decimais',
  })
  quantity!: string;
}

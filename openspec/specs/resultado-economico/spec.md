...
O sistema SHALL permitir a parametrização dos coeficientes de venda $K$ por linha e grupo de custo: taxa de garantias e cauções contratuais, taxa de seguros (riscos de engenharia e responsabilidade civil), imposto sobre produção, taxa de IDDE, risco país/cliente, custo financeiro de capital, contingências de obra, taxa de administração central/estrutura e margem de lucro líquido alvo.
...
O sistema SHALL permitir a simulação de contingências técnicas e geotécnicas (ex.: aumento de 15% em solo rochoso, acréscimo de extensões de acessos difíceis ou substituição de torres autoportantes por estaiadas), computando o reflexo financeiro imediato no custo e na margem.

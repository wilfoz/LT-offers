...
- [x] 5.1 Registrar rotas lazy em `catalogs.routes.ts` e adicionar item no menu de navegação da casca (`app.component.ts`), atualizando testes de rota e navegação.
